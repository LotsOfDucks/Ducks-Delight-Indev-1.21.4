                    ...
                    if (var14 instanceof FluidDrainable fluidDrainable) {
                        ...
                        if (!itemStack2.isEmpty()) {
                            ...
                            if (blockState.getFluidState().isOf(Fluids.WATER)) {
                                return ActionResult.SUCCESS.withNewHandStack(ModItems.HAUNTED_STEEL_WATER_BUCKET.getDefaultStack());
                            } else if (blockState.getFluidState().isOf(Fluids.LAVA)) {
                                return ActionResult.SUCCESS.withNewHandStack(ModItems.HAUNTED_STEEL_LAVA_BUCKET.getDefaultStack());
                            }
                        }
                    }
